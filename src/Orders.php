...
{
    /**
     * $var string endpoint for single order
     */
    protected $_endpoint = "Order";

    /**
     * $var string endpoint for plural order
     */
    protected $_endpointPlural = "Orders";
    ...
    /**
     * @brief Retrieve a single specified order
     *
    ...
    /**
     * @brief Retrieve a list of orders, handle pagination
     *
    ...
    /**
     * @brief Retrieve a list of orders
     *
     * @param mixed[] $requestParams Array of parameters to submit with GET request. All parameters are optional but if "ids"
     *                               are not specified, all will be selected.
     *                               Possible array keys: "ids","start","range","sort","sortDir","condition","search",
    ...
    /**
     * @brief Retrieve information (such as number of orders) about order collection
     *
    ...
    /**
     * @brief Retrieve meta for an order object
     *
     * @return string JSON formatted response
     */
    ...
    /**
     * @brief Delete a single specified order
     *
    ...
    /**
     * @brief Delete multiple orders according to specific criteria
     *
